...
Where the Level of Service tools for our model give us an idea of how our system is performing and how land acquisition or park property development could be used to improve access, our Neighborhood and Community Connections program and associated tools help us to think about how we can improve how well our system serves the population through means other than land acquisition and developing new parks. In particular, this program is concerned with providing safer, shorter bike and pedestrian access to parks.

To do this we use measures of network circuitry, pedestrian experience, and citizen vulnerability to help understand where these access improvements can have the greatest impact.
